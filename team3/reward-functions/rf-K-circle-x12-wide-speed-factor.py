...
def reward_function(params):
    speed = params['speed']
    speed_reward = speed / params['max_speed']
    
    if params['is_left_turn'] or params['is_right_turn']:
        curve_factor = 0.5  
    else:
        curve_factor = 1.0 
    
    return float(score_steer_to_point_ahead(params)) * speed_reward * curve_factor
